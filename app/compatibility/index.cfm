...
notesByIssue = {
  ...
  "02":"Custom tags resolve through same-directory cf_ tags and customtags/cfmodule paths, including body content.",
  ...
  "06":"cfqueryparam attributeCollection is honoured for Moopa's dynamic CRUD parameter style.",
  "07":"returntype=array returns the expected Array of row structs.",
  "08":"Direct UUID/timestamptz selection deserializes to CFML-native shapes.",
  ...
  "12":"Classic and modern localMode both behave per spec in the current RustCFML container.",
  ...
  "16":"returntype=struct with columnkey works for pg_indexes metadata.",
  "17":"row_to_json plus deserializeJSON roundtrip works like a lightweight db.read response.",
  ...
  "21":"Relative and leading-slash cfinclude both resolve correctly via the webroot."
};
rows = [];
